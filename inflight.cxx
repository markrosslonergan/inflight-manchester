...
int output_distributions(gsl_rng * r, detector * DETECTOR, twoIP_channel * CHAN, double mS, bool hepevt, std::string flux_name, int NUMEVENTS)
{
	...
	for(m=0;m<NUMEVENTS;m++)
	{
		...
		// EXPANDED WORLD COORDINATES
		// double posx = (233+150+150)*gsl_rng_uniform(r) - 150;
		// double posy = (256+150+150)*gsl_rng_uniform(r) - 278;
		// double posz = (1037+200+50)*gsl_rng_uniform(r) - 200;
		// double time = 3750.;

		// FIDUCIAL TPC COORDINATES
		// 			Fiducial volume:
		// 10      < x <   246.35
		// -105.53 < y <   107.47
		// 10.1    < z <   1026.9
